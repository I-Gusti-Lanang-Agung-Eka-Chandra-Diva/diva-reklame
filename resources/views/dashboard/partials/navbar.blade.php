<div class="navbar-custom navbar navbar-expand-lg">
    <div class="container-fluid px-0">
        <a class="navbar-brand d-block d-md-none" href="../index-2.html">
            <img src="{{ asset('asset/assets/images/logo.jpeg') }}" alt="Image">
        </a>
                ...
                <a class="rounded-circle" href="#!" role="button" id="dropdownUser" data-bs-toggle="dropdown"
                    ...
                    <div class="avatar avatar-md avatar-indicators avatar-online">
                        <img alt="{{ auth()->user()->nama }}"
                            src="{{ auth()->user()->foto ? asset(auth()->user()->foto) : asset('asset/assets/images/logo.jpeg') }}"
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUser">
                    <div class="px-4 pb-0 pt-2">
                        ...
                        <div class="lh-1 ">
                            ...
                            <a href="{{ route('profile.index') }}" class="text-inherit fs-6">Tampilkan profil saya</a>
                        </div>
        ...
        <form action="{{ route('logout') }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah anda yakin ingin mengakhiri sesi anda saat ini?</p>
                </div>
